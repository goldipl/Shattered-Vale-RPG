...
const ENEMY_PLACEMENTS = [
  ...
  { x: 38 * TILE, y: 12 * TILE, type: 'slimeGreen' },
  { x: 44 * TILE, y: 5 * TILE, type: 'slimeGreen' },
  { x: 38 * TILE, y: 15 * TILE, type: 'slimeRed' },
  { x: 36 * TILE, y: 35 * TILE, type: 'slimeGreen' },
  { x: 35 * TILE, y: 22 * TILE, type: 'slimeRed' },
  { x: 42 * TILE, y: 36 * TILE, type: 'slimeRed' },
  { x: 33 * TILE, y: 8 * TILE, type: 'slimeRed' },
  { x: 35 * TILE, y: 10 * TILE, type: 'slimeGreen' },
  { x: 37 * TILE, y: 7 * TILE, type: 'slimeRed' },
  { x: 40 * TILE, y: 9 * TILE, type: 'slimeBlue' },
  { x: 42 * TILE, y: 8 * TILE, type: 'slimeRed' },
  { x: 45 * TILE, y: 7 * TILE, type: 'slimeRed' },
  { x: 34 * TILE, y: 14 * TILE, type: 'slimeGreen' },
  { x: 36 * TILE, y: 17 * TILE, type: 'slimeRed' },
  { x: 40 * TILE, y: 18 * TILE, type: 'slimeBlue' },
  { x: 43 * TILE, y: 16 * TILE, type: 'slimeRed' },
  { x: 33 * TILE, y: 24 * TILE, type: 'slimeRed' },
  { x: 37 * TILE, y: 26 * TILE, type: 'slimeBlue' },
  { x: 41 * TILE, y: 23 * TILE, type: 'slimeGreen' },
  { x: 44 * TILE, y: 25 * TILE, type: 'slimeRed' },
  { x: 34 * TILE, y: 32 * TILE, type: 'slimeGreen' },
  { x: 38 * TILE, y: 33 * TILE, type: 'slimeRed' },
  { x: 40 * TILE, y: 35 * TILE, type: 'slimeBlue' },
  { x: 43 * TILE, y: 34 * TILE, type: 'slimeBlue' },
  { x: 45 * TILE, y: 37 * TILE, type: 'slimeRed' },
  { x: 39 * TILE, y: 28 * TILE, type: 'slimeBlue' },
  { x: 36 * TILE, y: 29 * TILE, type: 'slimeRed' },
  { x: 43 * TILE, y: 6 * TILE, type: 'slimeRed' },
  { x: 44 * TILE, y: 8 * TILE, type: 'slimeGreen' },
  { x: 45 * TILE, y: 10 * TILE, type: 'slimeBlue' },
  { x: 46 * TILE, y: 7 * TILE, type: 'slimeRed' },
  { x: 47 * TILE, y: 9 * TILE, type: 'slimeGreen' },
  { x: 43 * TILE, y: 14 * TILE, type: 'slimeBlue' },
  { x: 44 * TILE, y: 17 * TILE, type: 'slimeRed' },
  { x: 45 * TILE, y: 19 * TILE, type: 'slimeGreen' },
  { x: 46 * TILE, y: 16 * TILE, type: 'slimeRed' },
  { x: 47 * TILE, y: 18 * TILE, type: 'slimeBlue' },
  { x: 43 * TILE, y: 24 * TILE, type: 'slimeGreen' },
  { x: 44 * TILE, y: 27 * TILE, type: 'slimeRed' },
  { x: 45 * TILE, y: 30 * TILE, type: 'slimeBlue' },
  { x: 46 * TILE, y: 33 * TILE, type: 'slimeGreen' },
  { x: 47 * TILE, y: 36 * TILE, type: 'slimeRed' },
  { x: 44 * TILE, y: 38 * TILE, type: 'slimeBlue' },
  { x: 46 * TILE, y: 39 * TILE, type: 'slimeRed' },
  { x: 47 * TILE, y: 34 * TILE, type: 'slimeGreen' },
  { x: 45 * TILE, y: 26 * TILE, type: 'slimeRed' },
  { x: 46 * TILE, y: 22 * TILE, type: 'slimeBlue' },
  { x: 47 * TILE, y: 13 * TILE, type: 'slimeGreen' },
